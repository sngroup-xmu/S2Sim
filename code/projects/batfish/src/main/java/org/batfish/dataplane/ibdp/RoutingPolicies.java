...
final class RoutingPolicies {
  ...
  @Nonnull private Map<String, RoutingPolicy> _policies;
  // For internal informational purposes only
  @Nonnull private final String _hostname;

  public Map<String, RoutingPolicy> getPolicies() {
    return _policies;
  }

  public void setPolicies(Map<String, RoutingPolicy> policies){_policies = ImmutableMap.copyOf(policies);}
}