...
public abstract class Repairer {
    ...
    */
   private List<ConfigurationLine> _deletedLines = new ArrayList<>();
   private List<ConfigurationLine> _addedLines = new ArrayList<>();

   public void addDeletedLine(Integer lineNum, String line) {
       _deletedLines.add(new ConfigurationLine(lineNum, line));
   }

   public void addDeletedLine(ConfigurationLine configurationLine) {
       _deletedLines.add(configurationLine);
   }
   ...
   public void addDeletedLines(List<ConfigurationLine> lines) {
       _deletedLines.addAll(lines);
   }

   public void addAddedLine(Integer lineNum, String line) {
       _addedLines.add(new ConfigurationLine(lineNum, line));
   }
