...
public final class BgpProtocolHelper {
  ...
  // public static Optional<Bgpv4Route> transformBgpRouteOnImport(Bgpv4Route bgpv4Route,
  //     BgpPeerConfigId ourConfigId, BgpPeerConfigId remoteConfigId, BgpPeerConfig ourConfig,
  //     BgpPeerConfig remoteConfig, BgpRoutingProcess remoteBgpRoutingProcess,
  //     BgpSessionProperties session, Type ipv4Unicast) {
  //   return null;
  // }
}
